...
typedef struct NodeStructure {
	...
	DISK_LBA blocks[MAX_BLOCKS_PER_FILE];		// Blocks //DISK_LBA es un entero (direccion de memoria).
	BOOLEAN freeNode;                        	// If the node is available //Boolean es un entero
} NodeStruct;
...
typedef struct MyFileSystemStructure {
	...
	BIT bitMap[NUM_BITS];            	// Bit map //Solo tenemos 1 bloque para guardar el numero de bloques
